...
export default function About() {
  return (
    <div className="max-w-6xl space-y-4 xl:mx-auto  mx-4">
      <h1 className="text-2xl font-medium text-amber-600 ">About</h1>
      <p>
        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nisi
        consequuntur explicabo nihil repellendus qui a, adipisci, expedita
        quidem blanditiis pariatur corporis facilis cupiditate, laboriosam earum
      ...
      <p>
        ...
        labore, dolor doloremque accusamus vitae consequatur, earum minus
        dolores asperiores!
      </p>
    </div>
  );
